...
urlpatterns = [
    ...
    path('registration-sucess', RegistrationSucessView.as_view(), name='base-registration-sucess'),
    path('registration-hostel-booking', HostelBookingRegistrationView.as_view(), name='base-registration-hostel-booking'),
